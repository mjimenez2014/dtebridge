...
class DoccomprasController < ApplicationController
  ...
  def import
    ...
    begin
      ...
      respond_to do |format|
          format.html { redirect_to :back, notice:"Tiene que seleccionar el archivo"}
      end
    end
  end
