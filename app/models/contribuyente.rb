class Contribuyente < ActiveRecord::Base
  ...
  validates :rut, :presence => {:message => "Este campo no puede estar en blanco!"}, length: {maximum: 10, :message => "RUT Ejemplo: 19987987-K"},:uniqueness=> {:message => " el Contribuyente ya existe!!!"}
